...
#include "com_unoperate_aerospike_BackupReader.h"
#include "dec_text.h"
#include "restore.h"
...
static int init(JNIEnv* env) {
  ...
  GOTO_ERR_IF_NOT_0(
      init_class(env, &jni_exception_class,
                 "com/unoperate/aerospike/exceptions/JNIException"));
  ...
  GOTO_ERR_IF_NOT_0(init_class(
      ...
      "com/unoperate/aerospike/exceptions/MalformedBackupDataException"));
  ...
  GOTO_ERR_IF_NOT_0(init_class(
      ...
      "com/unoperate/aerospike/exceptions/UnsupportedBackupEntryException"));
  ...
  GOTO_ERR_IF_NOT_0(init_class(env, &read_record_result_class,
                               "com/unoperate/aerospike/ReadRecordResult"));
  GOTO_ERR_IF_NOT_0(init_method(env, read_record_result_class, "<init>",
                                "([B)V", &read_record_result_valid_ctor,
                                false));
  GOTO_ERR_IF_NOT_0(
      init_method(env, read_record_result_class, "addBinValue",
                  "(Ljava/lang/String;Lcom/unoperate/aerospike/values/Value;)V",
                  &read_record_result_add_bin_value, false));

  // BackupReader
  GOTO_ERR_IF_NOT_0(init_class(env, &backup_reader_class,
                               "com/unoperate/aerospike/BackupReader"));
  GOTO_ERR_IF_NOT_0(
      init_method(env, backup_reader_class, "createValue",
                  "(Ljava/lang/Object;)Lcom/unoperate/aerospike/values/Value;",
 ...
 */
JNIEXPORT void JNICALL Java_com_unoperate_aerospike_BackupReader_openFile(
...
Java_com_unoperate_aerospike_BackupReader_closeFile(JNIEnv* env, jobject obj) {
  // NOLINTBEGIN(performance-no-int-to-ptr)
  io_read_proxy_t* fd =
      (io_read_proxy_t*)(*env)->GetLongField(env, obj, file_ptr_id);
  // NOLINTEND(performance-no-int-to-ptr)
 ...
 * object.
 */
JNIEXPORT jobject JNICALL Java_com_unoperate_aerospike_BackupReader_readRecord(
    JNIEnv* env, jobject obj, jobject ns) {
