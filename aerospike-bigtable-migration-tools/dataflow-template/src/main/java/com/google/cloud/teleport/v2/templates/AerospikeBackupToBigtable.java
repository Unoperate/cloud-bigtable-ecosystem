...
@Template(
    ...
    description =
        "This Dataflow batch pipeline reads Aerospike backup files and loads the data into Cloud Bigtable. "
            + "Failed writes to Bigtable are captured and written to a separate JSON file for inspection or retry. ",
